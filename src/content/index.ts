...
import type { WeekScene } from '../engine/week';
...
/** Сцены недели между матчами (engine/week.ts); имена подставляются при показе — партнёр свой, соперник следующий. */
export const WEEKS = weeksJson as WeekScene[];
