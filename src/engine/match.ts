...
import { BALANCE, COMPOSURE_CALM, MOMENTUM_BY_BOLDNESS, MOMENTUM_BY_TIER, MOMENTUM_COST_RECOVERY } from './balance';
...
export function applyChoice(
  ...
  state.momentum = clamp(state.momentum + byTier + recovery + boldness, -3, 3);
